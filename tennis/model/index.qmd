...
The overall predictive intervals are slightly conservative, while the smaller grass sample is under-dispersed. The independence assumption does not hold perfectly: successive signed market innovations for the same player have correlation 0.130 [0.105, 0.157] when appearances are one to seven days apart, compared with 0.005 [−0.085, 0.091] after more than 30 days. The market carries short-run information forward that the observation model does not represent.
