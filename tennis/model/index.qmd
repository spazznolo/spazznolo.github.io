...
```{mermaid}
flowchart TB
  entry["ENTRY<br/>experience Eᵢ · Eⱼ<br/>τ₀ · γₑ"] --> initial["entry strengths<br/>xᵢ,1 · xⱼ,1"]
  initial --> history["previous strengths<br/>xᵢ,t−1 · xⱼ,t−1"]
  history --> strength["current strengths<br/>xᵢ,t · xⱼ,t"]
  evolution["EVOLUTION<br/>age Aᵢ,t · Aⱼ,t · Δt<br/>β_g · β_d · q"] --> strength

  strength --> matchup["MATCH<br/>matchup mean ηₘ"]
  effects["surface effects<br/>uᵢ,s · uⱼ,s"] --> matchup
  surface["SURFACE<br/>τₛ"] -.-> effects

  matchup --> price["market log-odds<br/>yₘ"]
  observation["OBSERVATION<br/>margin Vₘ<br/>√r · γᵥ"] --> noise["observation SD<br/>√rₘ"]
  noise --> price

  class entry,evolution,surface,observation phase
```
