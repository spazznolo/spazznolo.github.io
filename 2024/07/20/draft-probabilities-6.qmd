...
1. A rank-ordered logit model was built using numerous publication rankings throughout the draft year to derive prospect pick probabilities, like this:
   ...
   ![Distribution of the difference in pick values, measured in 7-year predicted WAR, with an expected difference of 2.72 WAR.](/figs/draft-probabilities-4-4.png){fig-alt="Distribution of the difference in pick values, measured in 7-year predicted WAR, with an expected difference of 2.72 WAR." width="60%"}
