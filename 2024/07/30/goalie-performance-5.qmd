...
![](/figs/goalie-six-three.png){fig-alt="Braden Holtby's posterior adjusted save percentage over shots faced." width="60%"}
...
![](/figs/goalie-six-four.png){fig-alt="Average posterior adjusted save percentage through shots faced by career-size group." width="60%"}
