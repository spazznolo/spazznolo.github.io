...
<p> 
For example, Thatcher Demko in 2020 was scored on 99 times, but was expected to be scored on 105.7 times. This means he saved 6.7 goals above what he was expected to, and 6.7/105.7 = 0.0631 goals per expected goal. The simulation of a shot with probability 14% of becoming a goal then can be represented by a weighted coin flip with probabilities of (0.14-(0.14*0.0631)) = 13.1% for a goal and (1-P(goal)) = 86.9% for a save/miss.
</p>
