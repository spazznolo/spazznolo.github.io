...
description: "An overview of the data, labeling, and modeling services planned for tennis tracking at scale."
date: 2023-01-15
categories: []
sports:
  - Tennis
...
Some results from the [latest](https://app.roboflow.com/tennistracker-dogbm/tennis-tracker-duufq/deploy/15) model iteration:
