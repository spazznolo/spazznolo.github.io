...
![](/figs/goalie-performance-1-1.png){fig-alt="Distribution of career 5v5 Fenwick save percentages for goalies facing 200 or more shots." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-1-2.png){fig-alt="Fitted beta distribution for career Fenwick save percentages." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-1-3.png){fig-alt="Posterior save percentage distributions for Jake Oettinger and Jeremy Swayman." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-2-1.png){fig-alt="Career adjusted save percentage distribution with fitted beta and Weibull distributions." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-2-2.png){fig-alt="Posterior adjusted save percentage distributions for Jake Oettinger and Jeremy Swayman." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-2-3.png){fig-alt="Comparison of save percentage metrics and posterior adjusted save percentage." fig-align="center" width="100%"}
...
![](/figs/goalie-performance-3-1.png){fig-alt="Save percentage by goalie age, with lighter points for smaller groups." fig-align="center" width="60%"}
...
![](/figs/goalie-performance-3-2.png){fig-alt="Smoothed goalie age curve based on cumulative changes in save percentage." fig-align="center" width="60%"}
...
![](/figs/goalie-six-one.png){fig-alt="Cumulative distribution of career shots faced for goalies." fig-align="center" width="60%"}
...
![](/figs/goalie-six-two.png){fig-alt="Average adjusted save percentage by career seasons played." fig-align="center" width="60%"}
...
![](/figs/goalie-six-three.png){fig-alt="Career adjusted save percentage distributions split by career shots faced." fig-align="center" width="60%"}
...
![](/figs/goalie-six-four.png){fig-alt="Calibration of the logistic regression predicting a long goalie career." fig-align="center" width="60%"}
...
![](/figs/goalie-six-seven.png){fig-alt="Average posterior adjusted save percentage through shots faced by career-size group." fig-align="center" width="60%"}
...
![](/figs/goalie-six-six.png){fig-alt="Average goalie age through shots faced by career-size group." fig-align="center" width="60%"}
