...
![](/figs/draft-probabilities-4-1.png){fig-alt="Illustrative distribution for Bedard's seven-year prospect value." width="60%"}
...
![](/figs/draft-probabilities-4-2.png){fig-alt="Illustrative prospect value distributions, with greater uncertainty assigned to Michkov." width="68%"}

Sampling a prospect value and a draft order together produces a distribution for the value of every pick.

![](/figs/draft-probabilities-4-3.png){fig-alt="Pick value distributions after accounting for prospect availability and value uncertainty." width="68%"}
...
![](/figs/draft-probabilities-4-4.png){fig-alt="Distribution of the value difference between picks four and five." width="60%"}
