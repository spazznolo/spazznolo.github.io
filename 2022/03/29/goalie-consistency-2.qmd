...
![Expected standing point distributions for simulated goalie seasons.](/figs/goalie-one-one.png){fig-alt="Expected standing point distributions for simulated goalie seasons." width="70%"}

![A second comparison of expected standing point distributions across goalie consistency levels.](/figs/goalie-one-two.png){fig-alt="A second comparison of expected standing point distributions across goalie consistency levels." width="60%"}
...
![Comparison of standing point distributions for steady and randomly varying goalie expectations.](/figs/goalie-one-three.png){fig-alt="Comparison of standing point distributions for steady and randomly varying goalie expectations." width="60%"}
