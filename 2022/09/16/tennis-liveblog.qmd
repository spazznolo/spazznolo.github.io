...
![](/figs/frame_1173.jpg){fig-alt="Broadcast tennis court frame." width="60%"}
...
![](/figs/robust-camera-model-flow.png){fig-alt="Robust camera calibration model flow." width="60%"}
...
![](/figs/hough-line-ex-2.jpg){fig-alt="Hough-line court detection example." width="60%"}
...
![](/figs/hough-collage-1.jpg){fig-alt="Hough-line court detection results, iteration 1." width="90%"}
...
![](/figs/hough-collage-2.jpg){fig-alt="Hough-line court detection results, iteration 2." width="90%"}
...
![](/figs/hough-collage-3.jpg){fig-alt="Hough-line court detection results, iteration 3." width="90%"}
...
![](/figs/hough-line-ex-4.jpg){fig-alt="Hough-line court boundary detection." width="90%"}
...
![](/figs/hough-line-ex-3.jpg){fig-alt="Non-dominant color extraction example for player detection." width="90%"}
...
![](/figs/player-detect-1.png){fig-alt="Player detection result." width="60%"}
