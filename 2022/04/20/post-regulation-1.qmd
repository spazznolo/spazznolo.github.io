...
description: "An exploration of how important post-regulation play is to NHL standings."
date: 2022-04-20
categories:
...
This series of posts will attempt to address the effects of this change in playing format, by answering questions like: Does a team's regular season success translate to overtime success? Is a given game's regulation play an indicator for its overtime play? Does a team's play in overtime *before a goal is scored* indicate who is more likely win? Can we predict who will get the next shot? Is the chaos created by the playing format change an equalizer of sorts?
...
![Pre-overtime standing points per game compared with the percentage of games going to overtime.](/figs/post-regulation-zero-one.png){fig-alt="Pre-overtime standing points per game compared with the percentage of games going to overtime." width="70%"}

*Technically, you could make the case to drop the few historically [bad](https://www.hockey-reference.com/teams/COL/2017.html) [teams](https://www.hockey-reference.com/teams/DET/2020.html) as outliers, in which case there would be a slight but statistically significant decrease in overtime games as a team's standing performance increased, which would amount to roughly a 2.5% (about 2 games) difference in overtime games per season between the worst and best teams, but this is moving away from the spirit of the analysis and will be ignored.*
